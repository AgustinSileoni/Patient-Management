...
SELECT '223e4567-e89b-12d3-a456-426614174007',
       ...
       '2022-10-10'
WHERE NOT EXISTS (
    SELECT 1 FROM patient WHERE id = '223e4567-e89b-12d3-a456-426614174007'
);
...
SELECT '223e4567-e89b-12d3-a456-426614174008',
       ...
       '2024-04-20'
WHERE NOT EXISTS (
    SELECT 1 FROM patient WHERE id = '223e4567-e89b-12d3-a456-426614174008'
);
...
SELECT '223e4567-e89b-12d3-a456-426614174009',
       ...
       '2023-06-30'
WHERE NOT EXISTS (
    SELECT 1 FROM patient WHERE id = '223e4567-e89b-12d3-a456-426614174009'
);
...
SELECT '223e4567-e89b-12d3-a456-426614174010',
       ...
       '2023-01-22'
WHERE NOT EXISTS (
    SELECT 1 FROM patient WHERE id = '223e4567-e89b-12d3-a456-426614174010'
);
...
SELECT '223e4567-e89b-12d3-a456-426614174011',
       ...
       '2024-05-12'
WHERE NOT EXISTS (
    SELECT 1 FROM patient WHERE id = '223e4567-e89b-12d3-a456-426614174011'
);
...
SELECT '223e4567-e89b-12d3-a456-426614174012',
       ...
       '2022-11-11'
WHERE NOT EXISTS (
    SELECT 1 FROM patient WHERE id = '223e4567-e89b-12d3-a456-426614174012'
);
...
SELECT '223e4567-e89b-12d3-a456-426614174013',
       ...
       '2023-09-19'
WHERE NOT EXISTS (
    SELECT 1 FROM patient WHERE id = '223e4567-e89b-12d3-a456-426614174013'
);
...
SELECT '223e4567-e89b-12d3-a456-426614174014',
       ...
       '2024-03-29'
WHERE NOT EXISTS (
    SELECT 1 FROM patient WHERE id = '223e4567-e89b-12d3-a456-426614174014'
);